...
# Change optimzer type in here, code supports all
def execute_training(model, train_loader, val_loader, epochs=500, optimizer_type='rmsprop', learning_rate=0.001, weight_decay=0):
    # Setup training
